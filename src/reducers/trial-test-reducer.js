...
export default function(state = initialState, action) {
    switch (action.type) {
        case actionTypes.TRIAL_TEST_REQUEST:
            return {
                ...state,
                loading: true,
                error: false,
            }
        case actionTypes.TRIAL_TEST_SUCCESS:
            return {
                ...state,
                trialTest: action.payload,
                loading: false,
                error: false,
            }
        case actionTypes.TRIAL_TEST_FAILURE:
            return {
                ...state,
                loading: false,
                error: true,
            }
        case actionTypes.TRIAL_ANSWER_SELECTED: {
            const { questionId, answerId } = action.payload;
            const { trialTest: { questions, headers } } = state;
        ...
        case actionTypes.TRIAL_QUESTION_MARKED: {
