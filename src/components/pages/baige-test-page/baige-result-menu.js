...
import {loadBaigeTest, baigeRunning} from "actions/baige-test-actions";
...
const BaigeResultMenu = (props) => {
    const classes = useStyles();
    const history = useHistory();
    const theme = useTheme();

    const { baigeFinished, headers = [], onCellClick, onShowResultsClick } = props;
...
export default BaigeResultMenu;